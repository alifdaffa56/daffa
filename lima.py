                    ...
                    dz.sendMessage(msg.to,dzMID)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin or msg._from in staff:                                           
                                ...
                                dz.sendMessage(msg.to, None, contentMetadata={'mid': msg._from}, contentType=13)
                    	    ...
                    	    if msg._from in owner or msg._from in admin or msg._from in staff: 
                              contact = dz.getContact(sender)
                              image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
                              dz.sendMessage(msg.to, "Nama : "+str(contact.displayName))
                              dz.sendMessage(msg.to, None,contentMetadata={'mid': sender}, contentType=13)
                                
                        elif text.lower() == "mid":
                               dz.sendMessage(msg.to, msg._from)
                               ...
                               dz.sendMessage(msg.to, "ُوَعَلَيْكُمْ السَّلاَمُ وَرَحْمَةُ اللهِ وَبَرَكَاتُهُ  ")
                        elif text.lower() == 'waalaikumsalam':
                               dz.sendMessage(msg.to, "ُиαн gιтυ ∂σик кαк.. кαℓαυ α∂α уαиg ѕαℓαм ∂ι ʝαωαв.. тєяιмα кαѕιн кαк")
...
#==================[ REBOOT ]===================
                ...
                dz.sendMessage(msg.to, "%ss" % (elapsed_time/3))
